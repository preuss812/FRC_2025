...
public class SwerveToPoseTest2 extends Command {
  ...
  /** Creates a new SwerveToPoseTest2. */
  public SwerveToPoseTest2(
  ...
  public void initialize() {
    ...
    if (waypoints.size() > 0 && !startingPose.equals(nearTargetPose))
      new FollowTrajectoryPoseCommand(robotDrive, poseEstimatorSubsystem, null, startingPose, waypoints, nearTargetPose);
    else 
    {
