...
public class DriveChoreoPathCommand extends Command {
  ...
  private final PreussAutoDrive preussAutoDrive;
  ...
  , DrivingConfig config) {
    ...
    preussAutoDrive = new PreussAutoDrive(robotDrive, poseEstimatorSubsystem,config);
  ...
  public boolean isFinished() {
    return timer.get() >= trajectory.get().getTotalTime();
  }
